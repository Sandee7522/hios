...
import { getAuthToken, getUserRole } from "@/app/dashboard/utils/auth";
...
export default function CallToAction() {
  ...
  const handleClick = () => {
    if (!role) return router.push("/register");
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Link href="mailto:info@hamsainstitute.com">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 px-10 text-lg border-white/10 bg-transparent hover:bg-white/5 text-white backdrop-blur-sm rounded-full"
                >
                  Contact Us
                </Button>
              </Link>
