...
export default function Footer() {
  return (
    <footer className="relative z-50 bg-[#020617] pt-20 pb-10 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 leading-relaxed font-light">
              Dedicated to providing quality education and skill-based training
              to help students achieve academic and professional success.
            </p>
            <div className="flex items-center gap-4 pt-2">
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-blue-900/20 flex items-center justify-center text-blue-400 hover:bg-blue-600 hover:text-white transition-all duration-300"
              >
                <Facebook size={18} />
              </Link>
              <Link
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-slate-400">
                <div className="w-8 h-8 rounded-lg bg-blue-900/20 flex items-center justify-center shrink-0 -mt-1">
                  <MapPin className="h-4 w-4 text-blue-400" />
                </div>
                <span>
                  123 Education Lane, Knowledge City, Bangalore - 560001
                </span>
              </li>
