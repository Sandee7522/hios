            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    >
                        ...
                        <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-200 to-cyan-200">Admissions Open for 2026 Batch</span>
                    </motion.div>
                    ...
                    >
                        ...
                        <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-400 via-cyan-400 to-blue-500 drop-shadow-[0_0_15px_rgba(59,130,246,0.3)]">Occult Science</span>
                    </motion.h1>
